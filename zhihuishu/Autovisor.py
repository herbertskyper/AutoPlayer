...
# constants
login_url = "https://passport.zhihuishu.com/login#studentID"
# Xpath
...
def auto_login(_user, _pwd,_school):
    if not user or not pwd:
        raise UserWarning
    page.goto(login_url)

    page.locator('#clCode').fill(_user)
    page.locator('#clPassword').fill(_pwd)
    page.locator('#quickSearch').fill(_school)
    # page.locator('#schoolListCode :nth-match(li, 1)').click()
