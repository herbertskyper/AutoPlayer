...
COURSE_URL = 'https://course.hitsz.edu.cn/pro/lms/AfApajw6vee/16968219/studycontent'  # 要刷的课的地址（获取方式见README）
COOKIE = 'c76eq11m1hxjgsxp0khn4cmogrf98f2l'  # 打死也不要告诉别人哦（获取方式见README）
